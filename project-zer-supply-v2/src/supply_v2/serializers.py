...
def vendor_dict(vendor) -> dict[str, Any]:
    return {
...
def order_line_dict(line) -> dict[str, Any]:
    return {
...
def po_line_dict(line) -> dict[str, Any]:
    return {
...
def po_dict(platform: SupplyPlatform, po) -> dict[str, Any]:
    return {
        "po_id": po.po_id,
...
def dispute_dict(dispute) -> dict[str, Any]:
    return {
...
def shipment_dict(platform: SupplyPlatform, shipment) -> dict[str, Any]:
    return {
...
def receipt_dict(platform: SupplyPlatform, receipt) -> dict[str, Any]:
    return {
...
def order_dict(platform: SupplyPlatform, order) -> dict[str, Any]:
    return {
...
def invoice_dict(platform: SupplyPlatform, invoice) -> dict[str, Any]:
    return {
